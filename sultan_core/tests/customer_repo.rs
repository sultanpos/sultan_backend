...
use sultan_core::domain::model::customer::{CustomerCreate, CustomerFilter, CustomerUpdate};
use sultan_core::domain::model::pagination::PaginationOptions;
use sultan_core::snowflake::SnowflakeGenerator;
use sultan_core::storage::customer_repo::CustomerRepository;
...
fn default_filter() -> CustomerFilter {
    CustomerFilter {
        number: None,
        name: None,
        phone: None,
