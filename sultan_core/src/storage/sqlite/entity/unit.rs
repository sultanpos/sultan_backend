...
/// SeaORM entity for Unit of Measure table
///
/// This entity represents the `units` table in the database.
...
impl Model {
    ...
    pub fn to_domain(&self) -> crate::domain::model::product::UnitOfMeasure {
        crate::domain::model::product::UnitOfMeasure {
            id: self.id,
