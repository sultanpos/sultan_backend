...
//             async fn create<'a, C: ConnectionTrait>(&self, ctx: &RepoCtx<C>, id: i64, branch: &BranchCreate) -> DomainResult<()>;
//             async fn update<'a, C: ConnectionTrait>(&self, ctx: &RepoCtx<C>, id: i64, branch: &BranchUpdate) -> DomainResult<()>;
//             async fn delete<'a, C: ConnectionTrait>(&self, ctx: &RepoCtx<C>, id: i64) -> DomainResult<()>;
//             async fn get_all<'a, C: ConnectionTrait>(&self, ctx: &RepoCtx<C>) -> DomainResult<Vec<Branch>>;
//             async fn get_by_id<'a, C: ConnectionTrait>(&self, ctx: &RepoCtx<C>, id: i64) -> DomainResult<Option<Branch>>;
//         }
//     }
