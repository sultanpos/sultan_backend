...
pub struct AppState {
    ...
    pub purchase_order_service: Arc<dyn PurchaseOrderServiceTrait>,
...
impl FromRef<AppState> for Arc<dyn PurchaseOrderServiceTrait> {
    fn from_ref(app_state: &AppState) -> Self {
        app_state.purchase_order_service.clone()
    }
}
